...
<div id="kt_header" class="header  header-fixed ">
    ...
    <div class=" container-fluid  d-flex align-items-stretch justify-content-between">
        ...
        <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
            ...
            @else
                @php
                    $headerMenuTranslations = trans('header_menu');

                    if (!is_array($headerMenuTranslations)) {
                    ...
                    $isHelpHeaderRoute = request()->is('help/*');
                @endphp
                <!--begin::Header Menu-->
                <div id="kt_header_menu" class="header-menu header-menu-mobile  header-menu-layout-default ">
                    <!--begin::Header Nav-->
                    <ul class="menu-nav ">
                        <li class="menu-item menu-item-submenu menu-item-rel {{ $isHelpHeaderRoute ? '' : 'menu-item-open menu-item-here menu-item-active' }}"
                            data-menu-toggle="click" aria-haspopup="true">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <span class="menu-text">{{ $translateHeaderMenu('Pages') }}</span>
                                ...
                                <ul class="menu-subnav">
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="index.html" class="menu-link ">
                                            ...
                                            <span class="menu-text">{{ $translateHeaderMenu('My Account') }}</span>
                                        </a>
                                    </li>
                                    <li class="menu-item " aria-haspopup="true">
                                        <a href="javascript:;" class="menu-link ">
                                            ...
                                            <span class="menu-text">{{ $translateHeaderMenu('Task Manager') }}</span>
                                    ...
                                    <li class="menu-item  menu-item-submenu" data-menu-toggle="hover"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">{{ $translateHeaderMenu('Team Manager') }}</span>
                                            <i class="menu-arrow"></i>
                                        </a>
                                            ...
                                            <ul class="menu-subnav">
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        ...
                                                        <span class="menu-text">{{ $translateHeaderMenu('Add Team Member') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Edit Team Member') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Delete Team Member') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Team Member Reports') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Assign Tasks') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Promote Team Member') }}</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="menu-item  menu-item-submenu" data-menu-toggle="hover"
                                        ...
                                        <a href="#" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">{{ $translateHeaderMenu('Projects Manager') }}</span>
                                            <i class="menu-arrow"></i>
                                        </a>
                                        <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                            <ul class="menu-subnav">
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        ...
                                                        <span class="menu-text">{{ $translateHeaderMenu('Latest Projects') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Ongoing Projects') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Urgent Projects') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Completed Projects') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Dropped Projects') }}</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="menu-item " aria-haspopup="true">
                                        <a href="javascript:;" class="menu-link ">
                                            ...
                                            <span class="menu-text">{{ $translateHeaderMenu('Create New Project') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item  menu-item-submenu" data-menu-toggle="click" aria-haspopup="true">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <span class="menu-text">{{ $translateHeaderMenu('Features') }}</span>
                                <i class="menu-arrow"></i>
                            </a>
                                    ...
                                    <ul class="menu-content">
                                        <li class="menu-item ">
                                            <h3 class="menu-heading menu-toggle">
                                                <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                <span class="menu-text">{{ $translateHeaderMenu('Task Reports') }}</span>
                                                <i class="menu-arrow"></i>
                                            </h3>
                                            <ul class="menu-inner">
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        ...
                                                        <span class="menu-text">{{ $translateHeaderMenu('Latest Tasks') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        ...
                                                        <span class="menu-text">{{ $translateHeaderMenu('Pending Tasks') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        ...
                                                        <span class="menu-text">{{ $translateHeaderMenu('Urgent Tasks') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        ...
                                                        <span class="menu-text">{{ $translateHeaderMenu('Completed Tasks') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        ...
                                                        <span class="menu-text">{{ $translateHeaderMenu('Failed Tasks') }}</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="menu-item ">
                                            <h3 class="menu-heading menu-toggle">
                                                <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                <span class="menu-text">{{ $translateHeaderMenu('Profit Margins') }}</span>
                                                <i class="menu-arrow"></i>
                                            </h3>
                                            <ul class="menu-inner">
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Overall Profits') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Gross Profits') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Nett Profits') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Year to Date Reports') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Quarterly Profits') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Monthly Profits') }}</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="menu-item ">
                                            <h3 class="menu-heading menu-toggle">
                                                <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                <span class="menu-text">{{ $translateHeaderMenu('Staff Management') }}</span>
                                                <i class="menu-arrow"></i>
                                            </h3>
                                            <ul class="menu-inner">
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Top Management') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Project Managers') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Development Staff') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Customer Service') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Sales and Marketing') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Executives') }}</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="menu-item ">
                                            <h3 class="menu-heading menu-toggle">
                                                <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                <span class="menu-text">{{ $translateHeaderMenu('Tools') }}</span>
                                                <i class="menu-arrow"></i>
                                            </h3>
                                            <ul class="menu-inner">
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <span class="menu-text">{{ $translateHeaderMenu('Analytical Reports') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <span class="menu-text">{{ $translateHeaderMenu('Customer CRM') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <span class="menu-text">{{ $translateHeaderMenu('Operational Growth') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <span class="menu-text">{{ $translateHeaderMenu('Social Media Presence') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <span class="menu-text">{{ $translateHeaderMenu('Files and Directories') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <span class="menu-text">{{ $translateHeaderMenu('Audit & Logs') }}</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                        ...
                        <li class="menu-item  menu-item-submenu menu-item-rel" data-menu-toggle="click"
                            aria-haspopup="true">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <span class="menu-text">{{ $translateHeaderMenu('Apps') }}</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                    <li class="menu-item " aria-haspopup="true">
                                        <a href="javascript:;" class="menu-link ">
                                            ...
                                            <span class="menu-text">{{ $translateHeaderMenu('Reporting') }}</span>
                                        </a>
                                    </li>
                                    <li class="menu-item  menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">{{ $translateHeaderMenu('Social Presence') }}</span>
                                            <i class="menu-arrow"></i>
                                        </a>
                                        <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                            <ul class="menu-subnav">
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Reached Users') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('SEO Ranking') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('User Dropout Points') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Market Segments') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Opportunity Growth') }}</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="menu-item " aria-haspopup="true">
                                        <a href="javascript:;" class="menu-link ">
                                            ...
                                            <span class="menu-text">{{ $translateHeaderMenu('Sales & Marketing') }}</span>
                                        </a>
                                    </li>
                                    <li class="menu-item " aria-haspopup="true">
                                        <a href="javascript:;" class="menu-link ">
                                            ...
                                            <span class="menu-text">{{ $translateHeaderMenu('Campaigns') }}</span>
                                            <span class="menu-label">
                                    ...
                                    <li class="menu-item  menu-item-submenu" data-menu-toggle="hover"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">{{ $translateHeaderMenu('Deployment Center') }}</span>
                                            <i class="menu-arrow"></i>
                                        </a>
                                        <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                            <ul class="menu-subnav">
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Merge Branch') }}</span>
                                                        <span class="menu-label">
                                                ...
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Version Controls') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('Database Manager') }}</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item " aria-haspopup="true">
                                                    <a href="javascript:;" class="menu-link ">
                                                        <i class="menu-bullet menu-bullet-line"><span></span></i>
                                                        <span class="menu-text">{{ $translateHeaderMenu('System Settings') }}</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel {{ request()->is('help/*') ? 'menu-item-open menu-item-here' : '' }}"
                            data-menu-toggle="click" aria-haspopup="true">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <span class="menu-text">{{ $translateHeaderMenu('Help') }}</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ request()->is('help/logika-route') ? 'menu-item-active' : '' }}"
                                        aria-haspopup="true">
                                        <a href="{{ url('/help/logika-route') }}" class="menu-link ">
                                            <span class="svg-icon menu-icon">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Safe-chat.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                            ...
                                            <span class="menu-text">{{ $translateHeaderMenu('Logika Route') }}</span>
                                        </a>
                                    </li>
                                    <li class="menu-item {{ request()->is('help/logika-bilingual') ? 'menu-item-active' : '' }}"
                                        aria-haspopup="true">
                                        <a href="{{ url('/help/logika-bilingual') }}" class="menu-link ">
                                            <span class="svg-icon menu-icon">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Safe-chat.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                            ...
                                            <span class="menu-text">{{ $translateHeaderMenu('Logika Bilingual') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="topbar">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        @php
                            ...
                            $activeLanguageFlag = $activeLocale === 'id'
                                ? 'assets/media/svg/flags/004-indonesia.svg'
                                : 'assets/media/svg/flags/226-united-states.svg';
                        @endphp
                        <img class="h-20px w-20px rounded-sm" src="{{ $activeLanguageFlag }}" alt="" />
                    </div>
                </div>
                <!--end::Toggle-->
                <!--begin::Dropdown-->
            ...
            @php
                ...
                $headerDisplayName = $headerCurrentUser?->name ?? 'User';
                $headerFirstName = trim(explode(' ', $headerDisplayName)[0] ?? $headerDisplayName);
                $headerProfilePhoto = $headerCurrentUser?->avatar_url ?? asset('assets/media/users/default.jpg');
            @endphp
            <div class="dropdown">
                <!--begin::Toggle-->
                <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
                    <div class="btn w-auto btn-clean d-flex align-items-center btn-lg px-2 py-1">
                        <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Hi,</span>
                        <span
                            class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3 text-nowrap">{{ $headerFirstName }}</span>
                        <span class="symbol symbol-35">
                            <img alt="{{ $headerDisplayName }}" src="{{ $headerProfilePhoto }}" class="rounded-circle" />
                        </span>
                    </div>
                </div>
                <!--end::Toggle-->
