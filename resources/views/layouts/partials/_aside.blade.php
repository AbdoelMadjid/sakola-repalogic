            ...
            <ul class="menu-nav ">
                <li class="menu-item {{ request()->routeIs('dashboard') ? 'menu-item-active' : '' }}"
                    ...
                    <a href="/dashboard" class="menu-link">
                        ...
                        <span class="menu-text">{{ __('aside.dashboard') }}</span></a>
                </li>

                @include('layouts.partials._menu', [
                    'config' => config('menus.custom'),
                    'sectionTitle' => __('aside.custom'),
                ])

                @include('layouts.partials._menu', [
                    'config' => config('menus.layouts'),
                    'sectionTitle' => __('aside.layouts'),
                ])

                @include('layouts.partials._menu', [
                    'config' => config('menus.crud'),
                    'sectionTitle' => __('aside.crud'),
                ])

                @include('layouts.partials._menu', [
                    'config' => config('menus.features'),
                    'sectionTitle' => __('aside.features'),
                ])
            </ul>
