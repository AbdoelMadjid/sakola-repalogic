                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex flex-wrap justify-content-between mt-1">
                            <div class="d-flex flex-column flex-grow-1 pr-8">
                                ...
                                <span class="font-weight-bold text-dark-50">A second could be persuade people.You want
                                    people to bay objective</span>
                            </div>
...
@section('scripts')
    <script>
        window.RepalogicEngageBannerConfig = {
            enabled: true,
            storageKey: 'dashboard-pengumuman-akademik',
            title: 'Info Maintenance Akademik',
            message: 'Sinkronisasi nilai dan pembaruan kalender akademik dijadwalkan malam ini pukul 22.00 WIB. Silakan cek detail jadwal sebelum melakukan input data.',
            alertSymbol: '!',
            alertSymbolSize: '52px',
            alertSymbolBackgroundColor: '#FFF4DE',
            alertSymbolBorder: '1px solid rgba(255, 168, 0, 0.45)',
            alertSymbolColor: '#F64E60',
            primaryAction: {
                label: 'Lihat Profil',
                href: '{{ url('/profile') }}'
            }
