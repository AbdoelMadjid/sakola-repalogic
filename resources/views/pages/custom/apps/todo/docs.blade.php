                                ...
                                <div class="d-flex mr-3">
                                    ...
                                    <div class="navi navi-hover navi-active navi-link-rounded navi-bold d-flex flex-row">
                                        ...
                                        <div class="navi-item mr-2">
                                            <a href="/custom/apps/todo/tasks" class="navi-link">
                                        ...
                                        <!--begin::Item-->
                                        <div class="navi-item mr-2">
                                            <a href="/custom/apps/todo/docs" class="navi-link active">
                                    ...
                                    <ul class="navi navi-link-rounded navi-accent navi-hover flex-column mb-8 mb-lg-0"
                                        ...
                                        <li class="navi-item my-2">
                                            <a class="navi-link" data-toggle="tab" href="#">
                                                <span
                                                    class="navi-text text-dark-50 font-size-h6 font-weight-bold">Buying</span>
                                            </a>
                                        </li>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="navi-item mb-2">
                                            <a class="navi-link active" data-toggle="tab" href="#">
                                                <span class="navi-text text-dark font-size-h6 font-weight-bold">Product
                                                    Support</span>
                                            </a>
                                        </li>
                                        <!--end::Item-->
                                        ...
                                        <li class="navi-item mb-2">
                                            <a class="navi-link" data-toggle="tab" href="#">
                                                <span class="navi-text text-dark-50 font-size-h6 font-weight-bold">Account
                                                    Management</span>
                                            </a>
                                        </li>
                                        <!--end::Item-->
                                        ...
                                        <li class="navi-item mb-2">
                                            <a class="navi-link" data-toggle="tab" href="#">
                                                <span class="navi-text text-dark-50 font-size-h6 font-weight-bold">Product
                                                    Licenses</span>
                                            </a>
                                        </li>
                                        <li class="navi-item mb-2">
                                            <a class="navi-link" data-toggle="tab" href="#">
                                                <span class="navi-text text-dark-50 font-size-h6 font-weight-bold">Base
                                                    Installation</span>
                                            </a>
                                        </li>
                                        <!--end::Item-->
                                        ...
                                        <li class="navi-item mb-2">
                                            <a class="navi-link" data-toggle="tab" href="#">
                                                <span class="navi-text text-dark-50 font-size-h6 font-weight-bold">Project
                                                    Management</span>
                                            </a>
                                        </li>
                                        <!--end::Item-->
                                        ...
                                        <li class="navi-item mb-2">
                                            <a class="navi-link" data-toggle="tab" href="#">
                                                <span class="navi-text text-dark-50 font-size-h6 font-weight-bold">Member
                                                    Roles</span>
                                            </a>
                                        </li>
                                        <!--end::Item-->
                                        ...
                                        <li class="navi-item mb-2">
                                            <a class="navi-link" data-toggle="tab" href="#">
                                                <span class="navi-text text-dark-50 font-size-h6 font-weight-bold">Report
                                                    Generation</span>
                                            </a>
                                        </li>
                                        <!--end::Item-->
                                        ...
                                        <li class="navi-item mb-2">
                                            <a class="navi-link" data-toggle="tab" href="#">
                                                <span
                                                    class="navi-text text-dark-50 font-size-h6 font-weight-bold">Downloads</span>
                                            </a>
                                        </li>
                                        <!--end::Item-->
                                    </ul>
                                    ...
                                    <div class="accordion accordion-light accordion-light-borderless accordion-svg-toggle"
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="faqHeading1">
                                                <div class="card-title text-dark" data-toggle="collapse"
                                            ...
                                            <div id="faq1" class="collapse show" aria-labelledby="faqHeading1"
                                                data-parent="#faq">
                                                <div class="card-body text-dark-50 line-height-lg pl-12">Anim pariatur
                                        ...
                                        <div class="card border-top-0">
                                            <div class="card-header" id="faqHeading2">
                                                <div class="card-title collapsed text-dark" data-toggle="collapse"
                                                    ...
                                                    <div class="card-label text-dark pl-4">Do I need a designer to use
                                                        Metronic?</div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card border-top-0">
                                            <div class="card-header" id="faqHeading3">
                                                <div class="card-title collapsed text-dark" data-toggle="collapse"
                                                    ...
                                                    <div class="card-label text-dark pl-4">What do I need to do to start
                                                        selling?</div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card border-top-0">
                                            <div class="card-header" id="faqHeading4">
                                                <div class="card-title collapsed text-dark" data-toggle="collapse"
                                                    ...
                                                    <div class="card-label text-dark pl-4">What happens when I receive an
                                                        order?</div>
                                                </div>
                                            </div>
                                            <div id="faq4" class="collapse" aria-labelledby="faqHeading4"
                                                data-parent="#faq">
                                                <div class="card-body text-dark-50 line-height-lg pl-12">Anim pariatur
                                                    cliche reprehenderit, enim eiusmod high life accusamus terry richardson
                                                    ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor
                                        ...
                                        <div class="card border-top-0">
                                            <div class="card-header" id="faqHeading5">
                                                <div class="card-title collapsed text-dark" data-toggle="collapse"
                                                    ...
                                                    <div class="card-label text-dark pl-4">What are the supported
                                                        third-party payments?</div>
                                                </div>
                                            </div>
                                            <div id="faq5" class="collapse" aria-labelledby="faqHeading5"
                                                data-parent="#faq">
                                                <div class="card-body text-dark-50 line-height-lg pl-12">Anim pariatur
                                                    cliche reprehenderit, enim eiusmod high life accusamus terry richardson
                                                    ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor
                                        ...
                                        <div class="card border-top-0">
                                            <div class="card-header" id="faqHeading6">
                                                <div class="card-title collapsed text-dark" data-toggle="collapse"
                                                    ...
                                                    <div class="card-label text-dark pl-4">What currencies are available?
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="faq6" class="collapse" aria-labelledby="faqHeading6"
                                                data-parent="#faq">
                                                <div class="card-body text-dark-50 line-height-lg pl-12">Anim pariatur
                                                    cliche reprehenderit, enim eiusmod high life accusamus terry richardson
                                                    ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor
                                        ...
                                        <div class="card border-top-0">
                                            ...
                                            <div id="faq7" class="collapse" aria-labelledby="faqHeading7"
                                                data-parent="#faq">
                                                <div class="card-body text-dark-50 line-height-lg pl-12">Anim pariatur
                                                    cliche reprehenderit, enim eiusmod high life accusamus terry richardson
                                                    ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor
                                        ...
                                        <div class="card border-top-0">
                                            <div class="card-header" id="faqHeading8">
                                                <div class="card-title collapsed text-dark" data-toggle="collapse"
                                                    ...
                                                    <div class="card-label text-dark pl-4">What is a merchant agreement?
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="faq8" class="collapse" aria-labelledby="faqHeading8"
                                                data-parent="#faq">
                                                <div class="card-body text-dark-50 line-height-lg pl-12">Anim pariatur
                                                    cliche reprehenderit, enim eiusmod high life accusamus terry richardson
                                                    ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor
                                        ...
                                        <div class="card border-top-0">
                                            <div class="card-header" id="faqHeading9">
                                                <div class="card-title collapsed text-dark" data-toggle="collapse"
                                                    ...
                                                    <div class="card-label text-dark pl-4">Where can I find my sales
                                                        reports?</div>
                                                </div>
                                            </div>
                                            <div id="faq9" class="collapse" aria-labelledby="faqHeading9"
                                                data-parent="#faq">
                                                <div class="card-body text-dark-50 line-height-lg pl-12">Anim pariatur
                                                    cliche reprehenderit, enim eiusmod high life accusamus terry richardson
                                                    ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor
