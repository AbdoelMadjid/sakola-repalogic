                        ...
                        <div class="d-flex justify-content-between flex-column h-100">
                            ...
                            <div class="h-100">
                                ...
                                <div class="d-flex flex-column flex-center">
                                    ...
                                    <!--begin::Title-->
                                    <a href="#"
                                        class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1">Maths
                                        Class</a>
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    <div class="font-weight-bold text-dark-50 font-size-sm pb-7">11:20-12:00, Mark Liam
                                    </div>
                                    <!--end::Text-->
                                </div>
                                <!--end::Header-->
                            ...
                            <div class="d-flex flex-center" id="kt_sticky_toolbar_chat_toggler_3" data-toggle="tooltip"
                                ...
                                <button class="btn btn-primary font-weight-bolder font-size-sm py-3 px-14"
                                    data-toggle="modal" data-target="#kt_chat_modal">Contact Teacher</button>
                            </div>
                            <!--end::Footer-->
                        </div>
                        <!--end::Wrapper-->
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1">
                                        <a href="#"
                                            class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">WWII
                                            Quiz Pt 1</a>
                                        <div class="d-flex">
                                ...
                                <form class="position-relative">
                                    <textarea id="kt_forms_widget_8_input" class="form-control border-0 p-0 pr-10 resize-none" rows="1"
                                        placeholder="Any Question?"></textarea>
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-3">
                                    <!--begin::Text-->
                                    <p class="text-dark-75 font-size-lg font-weight-normal pt-5 mb-7">Outlines keep you
                                        honest. They stop you from indulging in poorly thought-out metaphors</p>
                                    <!--end::Text-->
                                    <!--begin::Video-->
                                    ...
                                    <!--begin::Action-->
                                    <a href="#"
                                        class="btn btn-hover-text-primary btn-hover-icon-primary btn-sm btn-text-dark-50 bg-hover-light-primary rounded font-weight-bolder font-size-sm p-2 mt-7">
                                        <span class="svg-icon svg-icon-md svg-icon-dark-25 pr-2">
                                            <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Group-chat.svg-->
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                ...
                                <!--begin::Editor-->
                                <form class="position-relative">
                                    <textarea id="kt_forms_widget_9_input" class="form-control border-0 p-0 pr-10 resize-none" rows="1"
                                        placeholder="Any Question?"></textarea>
                                    <div class="position-absolute top-0 right-0 mt-n1 mr-n2">
                                        <span class="btn btn-icon btn-sm btn-hover-icon-primary">
                                            <i class="flaticon2-clip-symbol icon-ms"></i>
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-body">
                                ...
                                <!--begin::Editor-->
                                <form class="position-relative">
                                    <textarea id="kt_forms_widget_10_input" class="form-control border-0 p-0 pr-10 resize-none" rows="1"
                                        placeholder="Any Question?"></textarea>
                                    <div class="position-absolute top-0 right-0 mt-n1 mr-n2">
                                        <span class="btn btn-icon btn-sm btn-hover-icon-primary">
                                            <i class="flaticon2-clip-symbol icon-ms"></i>
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-3">
                                    ...
                                    <div class="pt-6">
                                        <a href="#"
                                            class="btn btn-light-primary btn-sm rounded font-weight-bolder font-size-sm p-2">
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap">
                                                <a href="#"
                                                    ...
                                                    Anderson</a>
                                                <span class="text-muted font-weight-normal flex-grow-1 font-size-sm">1 Day
                                                    ago</span>
                                                <span class="text-muted font-weight-normal font-size-sm">Reply</span>
                                            </div>
                                            <span class="text-dark-75 font-size-sm font-weight-normal pt-1">Long before you
                                                sit dow to put digital pen to paper you need to make sure you have to sit
                                                down and write.</span>
                                            <!--end::Info-->
                                        </div>
                                        <!--end::Info-->
                                    ...
                                    <div class="d-flex pt-6">
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid">
                                            ...
                                            <span class="text-dark-75 font-size-sm font-weight-normal pt-1">Long before you
                                                sit down to put digital pen to paper</span>
                                            <!--end::Info-->
                                        </div>
                                        <!--end::Info-->
                                    </div>
                        ...
                        <div class="d-flex flex-center pb-1">
                            <button class="btn btn-primary font-weight-bolder font-size-sm py-3 px-9"
                                id="kt_app_education_more_feeds_btn">More Topics</button>
                        </div>
                    </div>
                    <div class="col-xxl-6">
