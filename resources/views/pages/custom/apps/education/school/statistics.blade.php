                    ...
                    <div class="col-xxl-6">
                                ...
                                <div class="card-spacer mt-n25">
                                    ...
                                    <div class="row m-0">
                                        <div class="col bg-white px-6 py-8 rounded-xl mr-7 mb-7">
                                            ...
                                            <a href="#" class="text-info font-weight-bold font-size-h6">Weekly
                                                Sales</a>
                                        </div>
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-body p-0 d-flex flex-column">
                                ...
                                <!--end::Stats-->
                                <!--begin::Chart-->
                                <div id="kt_mixed_widget_13_chart" class="card-rounded-bottom" style="height: 200px">
                                </div>
                                <!--end::Chart-->
                            </div>
                            <!--end::Body-->
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center py-1">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                        <a href="#"
                                            class="text-dark font-weight-bolder text-hover-primary font-size-h5">Monthly
                                            Subscription
                                            <br />Based SaaS</a>
                                    ...
                                    <div class="d-flex align-items-center mb-8">
                                        ...
                                        <div>
                                            <a href="#"
                                                ...
                                                Sales</a>
                                            <div class="font-size-sm text-muted font-weight-bold mt-1">Authors with the
                                                best sales</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center mb-8">
                                        ...
                                        <div>
                                            <a href="#"
                                                ...
                                                Sales Lead</a>
                                            <div class="font-size-sm text-muted font-weight-bold mt-1">40% increased on
                                                week-to-week reports</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Widget Item-->
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <div class="d-flex align-items-center mr-2">
                                            ...
                                            <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                <div class="symbol-label">
                                                    <img src="assets/media/svg/misc/006-plurk.svg" class="h-50"
                                                        alt="" />
                                                </div>
                                            </div>
                                            <!--end::Symbol-->
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <div class="d-flex align-items-center mr-2">
                                            ...
                                            <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                <div class="symbol-label">
                                                    <img src="assets/media/svg/misc/015-telegram.svg" class="h-50"
                                                        alt="" />
                                                </div>
                                            </div>
                                            <!--end::Symbol-->
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center mr-2">
                                            ...
                                            <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                <div class="symbol-label">
                                                    <img src="assets/media/svg/misc/003-puzzle.svg" class="h-50"
                                                        alt="" />
                                                </div>
                                            </div>
                                            <!--end::Symbol-->
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                                    <div class="d-flex flex-column mr-2">
                                        <a href="#"
                                            class="text-dark-75 text-hover-primary font-weight-bolder font-size-h5">Weekly
                                            Sales</a>
