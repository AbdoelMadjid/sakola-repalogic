                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-body text-center pt-4">
                                ...
                                <div class="my-2">
                                    <a href="#"
                                        class="text-dark font-weight-bold text-hover-primary font-size-h4">John Beans</a>
                                </div>
                                <!--end::Name-->
                                <!--begin::Label-->
                                <span
                                    class="label label-inline label-lg label-light-warning btn-sm font-weight-bold">Active</span>
                                <!--end::Label-->
                                <!--begin::Buttons-->
                                <div class="mt-9 mb-6">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-body text-center pt-4">
                                ...
                                <div class="my-2">
                                    <a href="#"
                                        class="text-dark font-weight-bold text-hover-primary font-size-h4">Matt Pears</a>
                                </div>
                                <!--end::Name-->
                                <!--begin::Label-->
                                <a href="#"
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-body text-center pt-4">
                                ...
                                <div class="my-2">
                                    <a href="#"
                                        class="text-dark font-weight-bold text-hover-primary font-size-h4">Jessica
                                        Miles</a>
                                </div>
                                <!--end::Name-->
                                <!--begin::Label-->
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-body text-center pt-4">
                                ...
                                <div class="my-2">
                                    <a href="#"
                                        class="text-dark font-weight-bold text-hover-primary font-size-h4">Sarah May</a>
                                </div>
                                <!--end::Name-->
                                <!--begin::Label-->
                                <a href="#"
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-body text-center pt-4">
                                ...
                                <div class="my-2">
                                    <a href="#"
                                        class="text-dark font-weight-bold text-hover-primary font-size-h4">Teresa Wild</a>
                                </div>
                                <!--end::Name-->
                                <!--begin::Label-->
                                <a href="#"
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-body text-center pt-4">
                                ...
                                <div class="my-2">
                                    <a href="#"
                                        class="text-dark font-weight-bold text-hover-primary font-size-h4">Luca Doncic</a>
                                </div>
                                <!--end::Name-->
                                <!--begin::Label-->
                                <a href="#"
