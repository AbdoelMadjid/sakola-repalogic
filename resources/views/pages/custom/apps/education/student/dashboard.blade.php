                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between flex-column pt-4 h-100">
                            ...
                            <div class="pb-5">
                                ...
                                <div class="pt-1">
                                    <!--begin::Text-->
                                    <p class="text-dark-75 font-weight-nirmal font-size-lg m-0 pb-7">Outlines keep you
                                        honest. If poorly thought-out metaphors driving or create keep structure</p>
                                    <!--end::Text-->
                                    <!--begin::Item-->
                            ...
                            <div class="d-flex flex-center" id="kt_sticky_toolbar_chat_toggler_1" data-toggle="tooltip"
                                ...
                                <button class="btn btn-primary font-weight-bolder font-size-sm py-3 px-14"
                                    data-toggle="modal" data-target="#kt_chat_modal">Write a Message</button>
                            </div>
                            <!--end::Footer-->
                        </div>
                        <!--end::Wrapper-->
                                            ...
                                            <table class="table table-borderless table-vertical-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <span
                                                                class="text-muted font-weight-bolder d-block font-size-lg">9:20
                                                                - 10:00</span>
                                                            <span
