                ...
                <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center flex-wrap justify-content-between">
                            <div class="flex-grow-1 font-weight-bold text-dark-50 py-5 py-lg-2 mr-5">I distinguish
                                three main text objectives could be merely to inform people.
                            ...
                            <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="text-dark-75 font-weight-bolder d-block font-size-lg">$4,600</span>
                    ...
                    <div class="card-header h-auto border-0">
                        ...
                        <div class="card-title py-5">
                            <h3 class="card-label">
                                ...
                                <span class="d-block text-muted mt-2 font-size-sm">More than 400+ new
                                    members</span>
                            </h3>
                        </div>
                        <!--end::Title-->
