...
@endslot
        @slot('other')
            <div class="d-flex align-items-center" id="kt_subheader_search">
                <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">Nexa - Next generation SAAS</span>
            </div>
        @endslot
        @slot('action')
                ...
                <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center flex-wrap justify-content-between">
                            <div class="flex-grow-1 font-weight-bold text-dark-50 py-5 py-lg-2 mr-5">I distinguish three
                                main text objectives
