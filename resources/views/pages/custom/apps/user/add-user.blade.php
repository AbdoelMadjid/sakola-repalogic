                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-9">
                                                ...
                                                <div class="my-5 step" data-wizard-type="step-content"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <span class="form-text text-muted">Enter valid US phone
                                                                number(e.g: 5678967456).</span>
                                                        </div>
                                                    </div>
                                                    <!--end::Group-->
                                                    <!--begin::Group-->
                                                ...
                                                <div class="my-5 step" data-wizard-type="step-content">
                                                        ...
                                                        <div class="col-xl-9 col-lg-9">
                                                            <select class="form-control form-control-lg form-control-solid"
                                                                ...
                                                                <option data-offset="-10800"
                                                                    value="Atlantic Time (Canada)">(GMT-03:00) Atlantic
                                                                    Time (Canada)</option>
                                                    ...
                                                    <div class="form-group row">
                                                        <label
                                                            class="col-form-label col-xl-3 col-lg-3">Communication</label>
                                                    ...
                                                    <h5 class="text-dark font-weight-bold mb-10">User's Account Settings
                                                    </h5>
                                                    <!--begin::Group-->
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-9 col-lg-9">
                                                            ...
                                                            <div class="form-text text-muted mt-3">After you log in, you
                                                                will be asked for additional information to confirm your
                                                    ...
                                                    <!--begin::Group-->
                                                    <div class="form-group row">
                                                        <label class="col-form-label col-xl-3 col-lg-3">Password reset
                                                            verification</label>
                                                        <div class="col-xl-9 col-lg-9">
                                                            <div class="checkbox-inline">
                                                            ...
                                                            <div class="form-text text-muted">For extra security, this
