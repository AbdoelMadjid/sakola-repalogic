                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                            ...
                            <div class="my-lg-0 my-1">
                                <a href="#"
                                    class="btn btn-sm btn-light-primary font-weight-bolder text-uppercase mr-2">Ask</a>
                                <a href="#"
                                    class="btn btn-sm btn-primary font-weight-bolder text-uppercase">Hire</a>
                            </div>
                            <!--end::Actions-->
                        </div>
                        <!--end::Title-->
                        ...
                        <div class="d-flex align-items-center flex-wrap justify-content-between">
                            <!--begin::Description-->
                            <div class="flex-grow-1 font-weight-bold text-dark-50 py-2 py-lg-2 mr-5">I distinguish three
                                main text objectives could be merely to inform people.
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                            ...
                            <div class="mr-3">
                                <!--begin::Name-->
                                <a href="#"
                                    class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">Matt
                                    Pears
                                    <i class="flaticon2-correct text-success icon-md ml-2"></i></a>
                                <!--end::Name-->
                                <!--begin::Contacts-->
                        ...
                        <div class="d-flex align-items-center flex-wrap justify-content-between">
                            ...
                            <div class="d-flex mt-4 mt-sm-0">
                                <span class="font-weight-bold mr-4">Progress</span>
                                <div class="progress progress-xs mt-2 mb-2 flex-shrink-0 w-150px w-xl-250px">
                                    <div class="progress-bar bg-danger" role="progressbar" style="width: 53%;"
                                        aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
        ...
        <div class="card card-custom gutter-b">
            <div class="card-body">
                ...
                <div class="d-flex">
                    ...
                    <div class="flex-shrink-0 mr-7">
                        <div class="symbol symbol-50 symbol-lg-120">
                            <img alt="Pic" src="{{ asset('assets/media//users/300_10.jpg') }}" />
                        </div>
                    </div>
                    <!--end::Pic-->
                    <!--begin: Info-->
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                            ...
                            <div class="mr-3">
                                <!--begin::Name-->
                                <a href="#"
                                    class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">Charlie
                                    Stone
                                    <i class="flaticon2-correct text-success icon-md ml-2"></i></a>
                                <!--end::Name-->
                                <!--begin::Contacts-->
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                            ...
                            <div class="mr-3">
                                <!--begin::Name-->
                                <a href="#"
                                    class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">Sergei
                                    Ford
                                    <i class="flaticon2-correct text-success icon-md ml-2"></i></a>
                                <!--end::Name-->
                                <!--begin::Contacts-->
