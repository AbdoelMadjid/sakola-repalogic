                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            <div class="navi-item mb-2">
                                <a href="/custom/apps/profile/profile-1/overview" class="navi-link py-4">
                            ...
                            <div class="navi-item mb-2">
                                <a href="/custom/apps/profile/profile-1/email-settings" class="navi-link py-4 active">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
                    ...
                    <form class="form">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-xl-3 col-lg-3 col-form-label font-weight-bold text-left text-lg-right">When
                                    To Email</label>
                                <div class="col-lg-9 col-xl-6">
