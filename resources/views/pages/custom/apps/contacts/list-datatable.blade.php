    ...
    @component('layouts.partials._subheader.subheader-v1')
        ...
        @slot('action')
            <div class="d-flex align-items-center">
                <!--begin::Actions-->
                <a href="/custom/apps/contacts/add-contact" class="btn btn-light-primary font-weight-bold py-2 px-5 ml-2">Add
                    Contact</a>
                <!--end::Actions-->
                <!--begin::Dropdown-->
...
@endsection
@section('scripts')
    <script src="{{ asset('assets/js/pages/custom/contacts/list-datatable.js') }}"></script>
@endsection
