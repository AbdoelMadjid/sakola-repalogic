            ...
            <div class="col-xl-4">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body pt-2">
                        <p class="text-dark-50">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                ...
                                <form class="form">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="checkbox-inline">
                                                <label class="checkbox">
                                                    <input type="checkbox" />Require personal information to reset your
                                                    password.
                                                    <span></span></label>
                                            </div>
                                            <span class="form-text text-muted">For extra security, this requires you to
