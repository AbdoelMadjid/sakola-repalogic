                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <a href="#"
                                    class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary">James Jones</a>
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            <div class="navi-item mb-2">
                                <a href="/custom/apps/profile/profile-1/overview" class="navi-link py-4 active">
                            ...
                            <div class="navi-item mb-2">
                                <a href="/custom/apps/profile/profile-1/account-information" class="navi-link py-4">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
                            ...
                            <div class="navi-item mb-2">
                                <a href="/custom/apps/profile/profile-1/change-password" class="navi-link py-4">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
                            ...
                            <div class="navi-item mb-2">
                                <a href="/custom/apps/profile/profile-1/email-settings" class="navi-link py-4">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-body pt-4 d-flex flex-column justify-content-between">
                                ...
                                <p class="mb-7">I distinguish three
                                    <a href="#" class="text-primary pr-1">#XRS-54PQ</a>objectives First objectives
                                    and nice cooked rice
                                </p>
                                <!--end::Desc-->
                                <!--begin::Info-->
                                <div class="mb-7">
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-body pt-4 d-flex flex-column justify-content-between">
                                ...
                                <div class="d-flex align-items-center mb-7">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="#"
                                            class="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">Anna
                                            Krox</a>
                                ...
                                <div class="mb-7">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="text-dark-75 font-weight-bolder mr-2">Email:</span>
                                        <a href="#"
                                            class="text-muted text-hover-primary">giannis@fifestudios.com</a>
                                    </div>
                                ...
                                <!--end::Info-->
                                <a href="#"
                                    class="btn btn-block btn-sm btn-light-primary font-weight-bolder text-uppercase py-4">write
                                    message</a>
                            </div>
                            <!--end::Body-->
                        </div>
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-body pt-4 d-flex flex-column justify-content-between">
                                ...
                                <div class="d-flex align-items-center mb-7">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="#"
                                            class="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">Teresa
                                            Fox</a>
                                ...
                                <p class="mb-7">Lorem Ipsum is simply
                                    <a href="#" class="text-primary pr-1">#XRS-65PQ</a>dummy text of objectives and
                                    nice cooked rice
                                </p>
                                <!--end::Desc-->
                                <!--begin::Info-->
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-body pt-4 d-flex flex-column justify-content-between">
                                ...
                                <div class="d-flex align-items-center mb-7">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="#"
                                            class="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">Lisa
                                            Moss</a>
...
@endsection
@section('scripts')
    <script src="{{ asset('assets/js/pages/custom/contacts/list-columns.js') }}"></script>
@endsection
