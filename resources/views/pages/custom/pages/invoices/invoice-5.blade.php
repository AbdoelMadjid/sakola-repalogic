            ...
            <div class="card-body p-0">
                            ...
                            <div class="row justify-content-center py-8 px-8 py-md-27 px-md-0">
                                <div class="col-md-9">
                                    <div class="d-flex justify-content-between align-items-center flex-column flex-md-row">
                                        ...
                                        <h1 class="display-3 font-weight-boldest order-1 order-md-2 mb-5 mb-md-0">INVOICE
                                        </h1>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="position-relative">
                    ...
                    <div class="bgi-size-cover bgi-position-center bgi-no-repeat h-65px"
                        style="background-image: url(assets/media/svg/shapes/abstract-7.svg);"></div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="font-size-lg font-weight-bolder h-65px">
                                                ...
                                                <td
                                                    class="align-middle text-right border-0 text-danger font-weight-boldest font-size-h5 pr-0">
                                                    $4800.00</td>
                                            </tr>
                                            <tr class="font-size-lg font-weight-bolder h-65px">
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-7 mt-md-0">
                                    <!--begin::Invoice To-->
                                    <div class="text-dark-50 font-size-lg font-weight-bold mb-3 text-right">INVOICE TO.
                                    </div>
                                    ...
                                    <!--end::Invoice To-->
                                    <!--begin::Invoice No-->
                                    <div class="text-dark-50 font-size-lg font-weight-bold mb-3 text-right">INVOICE NO.
                                    </div>
                    ...
                    <div class="row justify-content-center py-8 px-8 py-md-28 px-md-0">
                        <div class="col-md-9">
                            <div class="d-flex font-size-sm flex-wrap">
                                ...
                                <button type="button"
                                    class="btn btn-light-danger font-weight-bolder mr-3 my-1 px-7">Download</button>
                                <button type="button"
                                    class="btn btn-primary font-weight-bolder ml-sm-auto my-1 px-7">Create Invoice</button>
                            </div>
                        </div>
                    </div>
                </div>
