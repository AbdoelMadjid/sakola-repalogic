                                    ...
                                    <form class="form mt-0 mt-lg-10" id="kt_form">
                                        ...
                                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control form-control-solid form-control-lg" name="fname"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control form-control-solid form-control-lg" name="lname"
                                        ...
                                        <div class="pb-5" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control form-control-solid form-control-lg" name="address2"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control form-control-solid form-control-lg"
                                                            name="state" placeholder="City" value="Melbourne" />
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <span class="form-text text-muted">Please enter your Card
                                                            Name.</span>
                                                    </div>
                                                    <!--end::Input-->
                                                </div>
