...
@section('styles')
    <link href="{{ asset('assets/css/pages/wizard/wizard-5.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('subheader')
                ...
                <div class="wizard wizard-5 d-flex flex-column flex-lg-row flex-row-fluid" id="kt_wizard">
                    ...
                    <div
                        ...
                        <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-y-bottom bgi-position-x-center bgi-size-contain pt-2 pt-lg-5 h-350px"
                            style="background-image: url(assets/media/svg/illustrations/features.svg)"></div>
                        <!--end::Aside Bottom-->
                    </div>
                    <!--begin::Aside-->
                    <!--begin::Content-->
                    <div class="wizard-content bg-gray-100 d-flex flex-column flex-row-fluid py-15 px-5 px-lg-10">
                        ...
                        <div class="text-right mb-lg-30 mb-15 mr-xxl-10">
                            ...
                            <a href="javascript:;" class="font-weight-bolder text-primary font-size-h4"
                            ...
                            <form class="pb-5 w-100 w-md-450px w-lg-500px" novalidate="novalidate" id="kt_form">
                                ...
                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            class="form-control h-auto p-6 border-0 rounded-lg font-size-h6" name="lastname"
                                ...
                                <div class="pb-5" data-wizard-type="step-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            class="form-control h-auto p-5 border-0 rounded-lg font-size-h6" name="address1"
                                            placeholder="Address Line 1" value="Address Line" />
                                    </div>
                                    <!--begin::Form Group-->
                                    <!--end::Row-->
                                    <div class="row">
...
@endsection
@section('scripts')
    <script src="{{ asset('assets/js/pages/custom/wizard/wizard-5.js') }}"></script>
@endsection
