    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body position-relative p-0 rounded-card-top">
                <!--begin::Pricing title-->
                <h3 class="bg-danger text-white text-center py-10 py-lg-20 m-0 rounded-card-top">Transparent &amp; Simple
                    Pricing</h3>
                <!--end::Pricing title-->
