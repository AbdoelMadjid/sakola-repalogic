                ...
                <div class="row justify-content-center my-20">
                    ...
                    <div class="col-md-4 col-xxl-3">
                        <div class="pt-30 pt-md-25 pb-15 px-5 text-center">
                            ...
                            <h4 class="font-size-h6 d-block d-block font-weight-bold mb-7 text-dark-50">1 End Product
                                License</h4>
                            ...
                            <a href="#" class="btn btn-primary text-uppercase font-weight-bolder px-15 py-3">Get For
                                Free</a>
                            <!--end::Content-->
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-xxl-3 border-x-0 border-x-md border-y border-y-md-0">
                        <div class="pt-30 pt-md-25 pb-15 px-5 text-center">
                            ...
                            <a href="#"
                                class="btn btn-primary text-uppercase font-weight-bolder px-15 py-3">Purchase</a>
                            <!--end::Content-->
                        </div>
                    </div>
                    <!--end: Pricing-->
                ...
                <div class="row my-10">
                    ...
                    <div class="col-md-6 col-xxl-3 border-right-0 border-right-xxl border-bottom border-bottom-xxl-0">
                        <div class="pt-30 pt-md-25 pb-15 px-5 text-center">
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="button"
                                    class="btn btn-success text-uppercase font-weight-bolder px-15 py-3">Purchase</button>
                            </div>
                        </div>
                    </div>
                    <!--end: Pricing-->
                    ...
                    <div class="col-md-6 col-xxl-3 border-right-0 border-right-md border-bottom border-bottom-md-0">
                        <div class="pt-30 pt-md-25 pb-15 px-5 text-center">
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="button"
                                    class="btn btn-danger text-uppercase font-weight-bolder px-15 py-3">Purchase</button>
                            </div>
                        </div>
                    </div>
                    <!--end: Pricing-->
                    ...
                    <div class="col-md-6 col-xxl-3">
                        <div class="pt-30 pt-md-25 pb-15 px-5 text-center">
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="button"
                                    class="btn btn-warning text-uppercase font-weight-bolder px-15 py-3">Purchase</button>
                            </div>
                        </div>
                    </div>
                    <!--end: Pricing-->
