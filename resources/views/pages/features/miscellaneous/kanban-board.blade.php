...
@section('content')
    ...
    <div class="container">
        ...
        <div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
            ...
            <div class="alert-text">Kanban JavaScript UI widget. For more info please visit
                <a class="font-weight-bold" href="http://www.riccardotartaglia.it/jkanban/" target="_blank">Kanban
                    Home</a>or
                <a class="font-weight-bold" href="https://github.com/riktar/jkanban" target="_blank">Kanban GitHub Repo</a>.
            </div>
        </div>
        <!--end::Notice-->
        <!--begin::Card-->
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Control Dragging Board</h3>
                </div>
            </div>
            <div class="card-body">
        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-body">
                ...
                <div class="mt-4">
                    ...
                    <button class="btn font-weight-bold btn-light-danger mr-5" id="addToDo">Add element in "To Do"
                        Board</button>
