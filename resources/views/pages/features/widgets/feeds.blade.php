            ...
            <div class="col-xl-6 col-sm-12">
                    ...
                    <div class="card-body pt-2">
                        ...
                        <form class="form" id="kt_form_1">
                            <div class="form-group">
                                <input type="text" class="form-control border-0" name="name" placeholder="Name" />
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control border-0" name="email" placeholder="Email" />
                            </div>
                            <div class="form-group">
                                <textarea class="form-control border-0" name="memo" rows="4" placeholder="Message"
                                    id="kt_forms_widget_1_input"></textarea>
                            </div>
                            <div class="mt-10">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pt-5">
                            <!--begin::Text-->
                            <p class="text-dark-75 font-size-lg font-weight-normal mb-2">Outlines keep you honest. They
                                stop you from indulging in poorly thought-out metaphors about driving and keep you focused
                                on the overall structure of your post</p>
                            <!--end::Text-->
                            <!--begin::Action-->
                            <div class="d-flex align-items-center">
                                <a href="#"
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div>
                                <!--begin::Text-->
                                <p class="text-dark-75 font-size-lg font-weight-normal pt-5 mb-2">Outlines keep you honest.
                                    They stop you from indulging in poorly thought-out metaphors about driving and keep you
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column flex-grow-1">
                                <a href="#"
                                    class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">WWII Quiz
                                    Pt 1</a>
                                <div class="d-flex">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pt-3">
                            <!--begin::Text-->
                            <p class="text-dark-75 font-size-lg font-weight-normal pt-5 mb-7">Outlines keep you honest.
                                They stop you from indulging in poorly thought-out metaphors</p>
                            <!--end::Text-->
                            <!--begin::Video-->
            ...
            <div class="col-xl-6 col-sm-12">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div>
                                <!--begin::Text-->
                                <p class="text-dark-75 font-size-lg font-weight-normal">Outlines keep you honest. They stop
                                    you from indulging in poorly thought-out metaphors about driving and keep you focused on
                                ...
                                <div class="d-flex py-5">
                                    ...
                                    <div class="d-flex flex-column flex-row-fluid">
                                        ...
                                        <span class="text-dark-75 font-size-sm font-weight-normal pt-1">Long before you sit
                                            dow to put digital pen to paper you need to make sure you have to sit down and
                                            write.</span>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::Info-->
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="d-flex flex-column flex-row-fluid">
                                        ...
                                        <span class="text-dark-75 font-size-sm font-weight-normal pt-1">Long before you sit
                                            down to put digital pen to paper</span>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::Info-->
                                </div>
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pt-3">
                            <!--begin::Text-->
                            <p class="text-dark-75 font-size-lg font-weight-normal pt-5 mb-6">Outlines keep you honest.
                                They stop you from indulging in poorly thought-out metaphors about driving and keep you
                                focused on the overall structure of your post</p>
                            <!--end::Text-->
                            <!--begin::Username-->
