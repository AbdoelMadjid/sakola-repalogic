    ...
    <div class="container">
                        ...
                        <div class="flex-grow-1 p-8 card-rounded bgi-no-repeat d-flex align-items-center"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-xl-7">
                                    ...
                                    <p class="text-dark-50 my-5 font-size-xl font-weight-bold">Offering discounts for your
                                        online store can be a powerful weapon in to drive loyalty</p>
                ...
                <div class="card card-custom card-stretch gutter-b">
                    <div class="card-body d-flex p-0">
                        <div class="flex-grow-1 bg-light-success p-12 pb-40 card-rounded flex-grow-1 bgi-no-repeat"
                            ...
                            <p class="text-success pt-10 pb-5 font-size-h3 font-weight-bolder line-height-lg">Start with a
                                branding
                ...
                <div class="card card-custom card-stretch gutter-b">
                    <div class="card-body d-flex p-0">
                        <div class="flex-grow-1 bg-danger p-12 pb-40 card-rounded flex-grow-1 bgi-no-repeat"
                            ...
                            <p class="text-inverse-danger pt-10 pb-5 font-size-h3 font-weight-bolder line-height-lg">Start
                                with a branding
                                <br />site design modern
                                <br />content creation
                            </p>
                ...
                <div class="card card-custom card-stretch gutter-b">
                    <div class="card-body d-flex p-0">
                        <div class="flex-grow-1 p-12 card-rounded bgi-no-repeat d-flex flex-column justify-content-center align-items-start"
                            style="background-color: #FFF4DE; background-position: right bottom; background-size: auto 100%; background-image: url(assets/media/svg/humans/custom-8.svg)">
                            ...
                            <p class="text-dark-50 my-5 font-size-xl font-weight-bold">Start with a modern site design and
                                ...
                                <br />and features. All Premium blogs include custom CSS.
                            </p>
                            <a href="#" class="btn btn-danger font-weight-bold py-2 px-6">Join SaaS</a>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-0 d-flex">
                        <div
                            ...
                            <div class="position-absolute right-0 bottom-0 mr-5 overflow-hidden">
                                <img src="assets/media/svg/humans/custom-13.svg" class="max-h-200px max-h-xl-275px mb-n20"
                                    alt="" />
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    <div class="card-body d-flex p-0">
                        <div class="flex-grow-1 p-20 pb-40 bg-warning card-rounded flex-grow-1 bgi-no-repeat"
                            style="background-position: calc(100% + 0.5rem) bottom; background-size: 50% auto; background-image: url(assets/media/svg/humans/custom-10.svg)">
            ...
            <div class="col-xl-6">
                ...
                <div class="card card-custom card-stretch card-stretch-half gutter-b overflow-hidden">
                    <div class="card-body p-0 d-flex rounded bg-light-success">
                        ...
                        <div class="d-none d-md-flex flex-row-fluid bgi-no-repeat bgi-position-y-center bgi-position-x-left bgi-size-cover"
                            style="transform: scale(1.5) rotate(-26deg); background-image: url('assets/media/products/13.png')">
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-custom card-stretch card-stretch-half gutter-b overflow-hidden">
                    <div class="card-body p-0 d-flex rounded bg-light-danger">
                        ...
                        <div class="d-none d-md-flex flex-row-fluid bgi-no-repeat bgi-position-y-center bgi-position-x-left bgi-size-cover"
                            style="transform: scale(1.5) rotate(-26deg); background-image: url('assets/media/products/12.png')">
                        </div>
                    </div>
                </div>
                <!--end::Engage Widget 12-->
        ...
        <div class="row">
            <div class="col-xl-8">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    <!--begin::Card Body-->
                    <div
                        class="card-body d-flex rounded bg-primary p-12 flex-column flex-md-row flex-lg-column flex-xxl-row">
                        <!--begin::Image-->
                        ...
                        <div class="card card-custom w-auto w-md-300px w-lg-auto w-xxl-300px ml-auto">
                            ...
                            <div class="card-body px-12 py-10">
                                ...
                                <div class="font-size-sm mb-8">Outlines keep you honest. They stop you from indulging in
                                    poorly ought out metaphorsy about driving and keep you focused one the overall structure
                                    of your post</div>
                                <!--begin::Info-->
                    ...
                    <div class="card-body p-15 pb-20">
                        <div class="row mb-17">
                            <div class="col-xxl-5 mb-11 mb-xxl-0">
                                ...
                                <div class="card card-custom card-stretch">
                                    <div class="card-body p-0 rounded px-10 py-15 d-flex align-items-center justify-content-center"
                                        ...
                                        <img src="assets/media/products/21.png" class="mw-100 w-200px"
                            ...
                            <div class="col-xxl-7 pl-xxl-11">
                                <h2 class="font-weight-bolder text-dark mb-7" style="font-size: 32px;">Apple Earbuds
                                    Amazing Headset</h2>
                                <div class="font-size-h2 mb-7 text-dark-50">From
                                    <span class="text-info font-weight-boldest ml-2">$299.00</span>
                                </div>
                                <div class="line-height-xl">You also need to be able to accept that not every post is going
                                    to get your motor running. Some posts will feel like a chore, but if you have editorial
                                    control over what you write about, then choose topics you’d want to read – even if they
                                    relate to niche industries. The more excited you can be about your topic, the more
                                    excited your readers</div>
                            </div>
                        </div>
                        <div class="row mb-6">
                            <!--begin::Info-->
            ...
            <div class="col-xl-8">
                ...
                <div class="card card-custom">
                    <div class="card-body rounded p-0 d-flex bg-light">
                        ...
                        <div class="d-none d-md-flex flex-row-fluid bgi-no-repeat bgi-position-y-center bgi-position-x-left bgi-size-cover"
                            style="background-image: url(assets/media/svg/illustrations/copy.svg);"></div>
                    </div>
                </div>
