...
@section('content')
    ...
    <div class="container">
        ...
        <div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
            ...
            <div class="alert-text">Google chart tools are powerful, simple to use, and free. For more info please visit
                <a class="font-weight-bold" href="https://google-developers.appspot.com/chart/interactive/docs/quick_start"
                    target="_blank">Google Chart's home</a>.
            </div>
        </div>
        <!--end::Notice-->
        <!--begin::Row-->
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/pages/features/charts/google-charts.js') }}"></script>
@endsection
