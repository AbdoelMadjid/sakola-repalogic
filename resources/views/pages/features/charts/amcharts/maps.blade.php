...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Animation along lines</h3>
                </div>
            </div>
            <div class="card-body">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Map with curved lines</h3>
                </div>
            </div>
            <div class="card-body">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Zooming to Countries Map</h3>
                </div>
            </div>
            <div class="card-body">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Flight routes map</h3>
                </div>
            </div>
            <div class="card-body">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Grouped countries map</h3>
                </div>
            </div>
            <div class="card-body">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">US heat (choropleth) map</h3>
                </div>
            </div>
            <div class="card-body">
