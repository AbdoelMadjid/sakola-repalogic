...
@section('content')
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<div class="alert-text">Line Awesome replaces Font Awesome icons with modern line icons. For more info please visit
									<a class="font-weight-bold" href="https://icons8.com/line-awesome" target="_blank">Line Awesome Home</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Row-->
								<div class="row">
									<div class="col-xl-6">
										...
										<div class="card card-custom gutter-b card-stretch">
											...
											<div class="card-body">
												...
												<div class="example">
													<p>
													<code>Line Awesome</code>icons can be used as
													<code>class="fa {class}"</code>.</p>
									...
									<div class="col-xl-6">
										...
										<div class="card card-custom gutter-b card-stretch">
											...
											<div class="card-body">
												...
												<div class="example">
													<p>Use
													<code>.text-{light|secondary|success|info|primary|warning|danger|white|dark|dark-75|dark-50|dark-25}</code>class format to set different colors.</p>
													<div class="example-preview">
									...
									<div class="col-xl-6">
										...
										<div class="card card-custom gutter-b card-stretch">
											...
											<div class="card-body">
												...
												<div class="example">
													<p>Use
													<code>.icon-{size}</code>class format to set different sizes.</p>
													<div class="example-preview">
															...
															<div class="dropdown-menu dropdown-menu-md py-5">
																<ul class="navi navi-hover">
																	...
																	<li class="navi-item">
																		<a class="navi-link" href="#">
																			<span class="navi-icon">
																				<i class="la la-palette text-success"></i>
																			</span>
											...
											<div class="card card-custom">
												<div class="card-header">
													...
													<div class="card-toolbar">
														<span class="text-muted font-size-sm" id="la_count_text">Menampilkan 0 dari 0 icon</span>
													</div>
												</div>
												<div class="px-6 pt-4">
													<div class="form-row">
														<div class="col-md-5 mb-3">
															<label class="font-weight-bold mb-2" for="la_search_input">Pencarian Icon</label>
															<input type="text" id="la_search_input" class="form-control"
																placeholder="Cari nama icon, contoh: user, calendar, arrow">
														</div>
														<div class="col-md-3 mb-3">
															<label class="font-weight-bold mb-2" for="la_size_input">Ukuran Icon (px)</label>
															<select id="la_size_input" class="form-control">
														...
														<div class="col-md-2 mb-3">
															<label class="font-weight-bold mb-2" for="la_color_input">Warna Icon</label>
															<input type="color" id="la_color_input" class="form-control p-1" value="#000000">
														</div>
														<div class="col-md-2 mb-3 d-flex align-items-end">
															<button type="button" class="btn btn-light-primary font-weight-bold w-100" id="la_reset_btn">Reset</button>
														</div>
													</div>
														...
														<div class="row align-items-start">
															<div class="col-md-3 mb-3 mb-md-0">
																...
																<div class="border rounded bg-white d-flex align-items-center justify-content-center"
																	...
																	<i id="la_preview_icon" style="font-size: 64px;"></i>
																</div>
															</div>
															<div class="col-md-6 mb-3 mb-md-0">
																<label class="font-weight-bold mb-2 d-block">Hasil Copy Snippet</label>
																<textarea id="la_snippet_code" class="form-control" rows="3"
																...
																<div class="row mx-n1 mb-2">
																	<div class="col-6 px-1">
																		<button type="button" class="btn btn-primary font-weight-bold w-100"
																			id="la_copy_snippet_btn" disabled>Copy</button>
																	</div>
																	<div class="col-6 px-1">
																		<button type="button" class="btn btn-light-primary font-weight-bold w-100"
																			id="la_clear_selected_btn" disabled>Reset</button>
																	</div>
																</div>
																<div class="text-center" style="min-height: 20px;">
																	<span id="la_copy_status" class="text-muted small"></span>
																</div>
																<div class="text-center mt-2" style="min-height: 28px;">
																	<span id="la_icon_badge"
												...
												<div class="card-body" id="la_rows_container">
												<div class="row">
												...
												<div class="row">
													...
													<div class="col-md-2 d-flex align-items-stretch">
														<div class="d-flex flex-grow-1 align-items-center bg-hover-light p-4 rounded">
															...
															<div class="text-muted">fab la-adobe</div>
														</div>
													</div>
													<div class="col-md-2 d-flex align-items-stretch">
														<div class="d-flex flex-grow-1 align-items-center bg-hover-light p-4 rounded">
...
@section('scripts')
	<script>
		(function() {
			function initLineawesomeTools() {
				var container = document.getElementById('la_rows_container');
				var countText = document.getElementById('la_count_text');
				var searchInput = document.getElementById('la_search_input');
				var sizeInput = document.getElementById('la_size_input');
				var colorInput = document.getElementById('la_color_input');
				var resetBtn = document.getElementById('la_reset_btn');
				var previewIcon = document.getElementById('la_preview_icon');
				var iconBadge = document.getElementById('la_icon_badge');
				var snippetCode = document.getElementById('la_snippet_code');
				var copySnippetBtn = document.getElementById('la_copy_snippet_btn');
				var clearSelectedBtn = document.getElementById('la_clear_selected_btn');
				var copyStatus = document.getElementById('la_copy_status');
				...
				for (var labelIdx = 0; labelIdx < cardLabels.length; labelIdx++) {
					if ((cardLabels[labelIdx].textContent || '').trim() === 'Lineawesome Icons') {
						laCardHeader = cardLabels[labelIdx].closest('.card-header');
						break;
					}
				}
				...
				for (var idx = 0; idx < iconCards.length; idx++) {
					...
					iconRenderClass = iconRenderClass
						.replace(/\bicon-\S+\b/g, '')
						.replace(/\btext-\S+\b/g, '')
						.replace(/\s+/g, ' ')
						.trim();
					...
					iconCards[idx].setAttribute('data-icon-class', iconRenderClass || iconName);
				...
				function clearCopiedBadges() {
					for (var i = 0; i < iconCards.length; i++) {
						var badge = iconCards[i].querySelector('.la-copied-badge');
						if (badge) {
							badge.remove();
						}
					}
				...
				function showCopiedBadgeOnSelectedCard() {
					...
					for (var i = 0; i < iconCards.length; i++) {
						...
						badge.className = 'la-copied-badge';
				...
				function showCopyToast(message) {
					var toast = document.getElementById('la_copy_toast');
					if (!toast) {
						toast = document.createElement('div');
						toast.id = 'la_copy_toast';
				...
				for (var clickIdx = 0; clickIdx < iconCards.length; clickIdx++) {
					iconCards[clickIdx].addEventListener('click', function() {
						...
						if (laCardHeader) {
							var top = laCardHeader.getBoundingClientRect().top + window.pageYOffset - 120;
							window.scrollTo({
								top: Math.max(top, 0),
								behavior: 'smooth'
							});
			...
			if (document.readyState === 'loading') {
				document.addEventListener('DOMContentLoaded', initLineawesomeTools);
			} else {
				initLineawesomeTools();
			}
		})();
	</script>
@endsection
