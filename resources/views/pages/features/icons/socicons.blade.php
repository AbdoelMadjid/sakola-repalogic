...
@section('content')
    ...
    <div class="container">
        ...
        <div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
            ...
            <div class="alert-text">Socicon is a social icons font with more than 170 icons from all major services. Socicon
                is free and easy to use. For more info please visit
