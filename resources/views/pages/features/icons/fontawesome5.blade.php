...
@section('content')
    ...
    <div class="container">
        ...
        <div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
            ...
            <div class="alert-text">Get vector icons and social logos on your website with Font Awesome, the web's most
            ...
            <div class="col-xl-6">
                ...
                <div class="card card-custom gutter-b card-stretch">
                    ...
                    <div class="card-body">
                        ...
                        <div class="example">
                            <p>
                                <code>Fontawesome</code>icons can be used as
                                <code>class="fa {class}"</code>.
                            </p>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-md py-5" style="">
                                        <ul class="navi navi-hover">
                                            ...
                                            <li class="navi-item">
                                                <a class="navi-link" href="#">
                                                    <span class="navi-icon">
                                                        <i class="fa fa-fill-drip text-primary"></i>
                                                    </span>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <span class="text-muted font-size-sm" id="fa5_count_text">Menampilkan 0 dari 0 icon</span>
                        </div>
                    </div>
                    <div class="px-6 pt-4">
                        <div class="form-row">
                            <div class="col-md-5 mb-3">
                                <label class="font-weight-bold mb-2" for="fa5_search_input">Pencarian Icon</label>
                                <input type="text" id="fa5_search_input" class="form-control"
                                    placeholder="Cari nama icon, contoh: user, calendar, arrow">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="font-weight-bold mb-2" for="fa5_size_input">Ukuran Icon (px)</label>
                                <select id="fa5_size_input" class="form-control">
                            ...
                            <div class="col-md-2 mb-3">
                                <label class="font-weight-bold mb-2" for="fa5_color_input">Warna Icon</label>
                            ...
                            <div class="row align-items-start">
                                <div class="col-md-3 mb-3 mb-md-0">
                                    ...
                                    <div class="border rounded bg-white d-flex align-items-center justify-content-center"
                                        ...
                                        <i id="fa5_preview_icon" style="font-size: 64px;"></i>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3 mb-md-0">
                                    <label class="font-weight-bold mb-2 d-block">Hasil Copy Snippet</label>
                                    <textarea id="fa5_snippet_code" class="form-control" rows="3"
                                    ...
                                    <div class="row mx-n1 mb-2">
                                        <div class="col-6 px-1">
                                            <button type="button" class="btn btn-primary font-weight-bold w-100"
                                                id="fa5_copy_snippet_btn" disabled>Copy</button>
                                        </div>
                                        <div class="col-6 px-1">
                                            <button type="button" class="btn btn-light-primary font-weight-bold w-100"
                                                id="fa5_clear_selected_btn" disabled>Reset</button>
                                        </div>
                                    </div>
                                    <div class="text-center" style="min-height: 20px;">
                                        <span id="fa5_copy_status" class="text-muted small"></span>
                                    </div>
                                    <div class="text-center mt-2" style="min-height: 28px;">
                                        <span id="fa5_icon_badge"
                    ...
                    <div class="card-body" id="fa5_rows_container">
                        <div class="row">
                            ...
                            <div class="col-md-2 d-flex align-items-stretch">
                                <div class="d-flex flex-grow-1 align-items-center bg-hover-light p-4 rounded">
                                    ...
                                    <div class="text-muted">fab fa-adobe</div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
@section('scripts')
    <script>
        (function() {
            function initFontawesomeTools() {
                var container = document.getElementById('fa5_rows_container');
                var countText = document.getElementById('fa5_count_text');
                var searchInput = document.getElementById('fa5_search_input');
                var sizeInput = document.getElementById('fa5_size_input');
                var colorInput = document.getElementById('fa5_color_input');
                var resetBtn = document.getElementById('fa5_reset_btn');
                var previewIcon = document.getElementById('fa5_preview_icon');
                var iconBadge = document.getElementById('fa5_icon_badge');
                var snippetCode = document.getElementById('fa5_snippet_code');
                var copySnippetBtn = document.getElementById('fa5_copy_snippet_btn');
                var clearSelectedBtn = document.getElementById('fa5_clear_selected_btn');
                var copyStatus = document.getElementById('fa5_copy_status');
                ...
                for (var labelIdx = 0; labelIdx < cardLabels.length; labelIdx++) {
                    if ((cardLabels[labelIdx].textContent || '').trim() === 'Fontawesome Icons') {
                        faCardHeader = cardLabels[labelIdx].closest('.card-header');
                        break;
                    }
                }
                ...
                function clearCopiedBadges() {
                    for (var i = 0; i < iconCards.length; i++) {
                        var badge = iconCards[i].querySelector('.fa5-copied-badge');
                        if (badge) {
                            badge.remove();
                        }
                    }
                ...
                function showCopyToast(message) {
                    var toast = document.getElementById('fa5_copy_toast');
                    if (!toast) {
                ...
                for (var clickIdx = 0; clickIdx < iconCards.length; clickIdx++) {
                    iconCards[clickIdx].addEventListener('click', function() {
                        ...
                        if (faCardHeader) {
                            var top = faCardHeader.getBoundingClientRect().top + window.pageYOffset - 120;
                            window.scrollTo({
                                top: Math.max(top, 0),
                                behavior: 'smooth'
                            });
            ...
            if (document.readyState === 'loading') {
                document.addEventListener('DOMContentLoaded', initFontawesomeTools);
            } else {
                initFontawesomeTools();
            }
        })();
    </script>
@endsection
