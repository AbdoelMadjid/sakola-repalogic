...
@section('content')
    ...
    <div class="container">
        ...
        <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
            ...
            <div class="alert-text">This example shows a vertically scrolling DataTable that makes use of the CSS3 vh unit in
                order to dynamically resize the viewport based on the browser window height.</div>
        </div>
        <!--end::Notice-->
        <!--begin::Card-->
            ...
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Both Scrollbars
                        <span class="d-block text-muted pt-2 font-size-sm">Scrollable Horizontal &amp; Vertical
                            DataTable</span>
                    </h3>
                </div>
                <div class="card-toolbar">
