...
@section('content')
    ...
    <div class="container">
        ...
        <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
            ...
            <div class="alert-text">The example below shows a header spanning multiple cells over the contact information,
                with one of the columns that the span covers being hidden. See official documentation
                <a class="font-weight-bold" href="https://datatables.net/examples/advanced_init/complex_header.html"
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Multiple Controls</h3>
                </div>
