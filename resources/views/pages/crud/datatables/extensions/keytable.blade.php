...
@section('content')
    ...
    <div class="container">
        ...
        <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
            ...
            <div class="alert-text">Spreadsheet navigation of a DataTable makes for an attractive and rapid data input
                interface, and also a very familiar one for those users experienced in Excel, OpenOffice or similar, who are
                now transitioning to web based apps. See official documentation
                <a class="font-weight-bold" href="https://datatables.net/extensions/keytable/" target="_blank">here</a>.
            </div>
        </div>
        <!--end::Notice-->
        <!--begin::Card-->
            ...
            <div class="card-header">
                <div class="card-title">
                    <span class="card-icon">
                        <i class="flaticon2-cup text-primary"></i>
                    </span>
                    <h3 class="card-label">KeyTable DataTable</h3>
                </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/pages/crud/datatables/extensions/keytable.js') }}"></script>
@endsection
