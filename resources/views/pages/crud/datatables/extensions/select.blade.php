...
@section('content')
    ...
    <div class="container">
        ...
        <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
            ...
            <div class="alert-text">Select is an extension for DataTables that provides table item selection capabilities.
                See official documentation
                <a class="font-weight-bold" href="https://datatables.net/extensions/select/" target="_blank">here</a>.
            </div>
        </div>
        <!--end::Notice-->
        <!--begin::Card-->
            ...
            <div class="card-header">
                <div class="card-title">
                    <span class="card-icon">
                        <i class="flaticon2-safe text-primary"></i>
                    </span>
                    <h3 class="card-label">Select DataTable</h3>
                </div>
        ...
        <div class="card card-custom gutter-t">
            ...
            <div class="card-body">
                <!--begin: Datatable-->
                <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_datatable_2"
                    style="margin-top: 13px !important;">
                    <thead>
                        <tr>
                            <th>Record ID</th>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/pages/crud/datatables/extensions/select.js') }}"></script>
@endsection
