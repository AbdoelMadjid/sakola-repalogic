...
@section('content')
    ...
    <div class="container">
        ...
        <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
            ...
            <div class="alert-text">It provides the end user with the ability to click and drag (or touch and drag on mobile
                devices) a row in the table and change its position. See official documentation
                <a class="font-weight-bold" href="https://datatables.net/extensions/rowreorder/" target="_blank">here</a>.
            </div>
        </div>
        <!--end::Notice-->
        <!--begin::Card-->
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">RowReorder DataTable</h3>
                </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/pages/crud/datatables/extensions/rowreorder.js') }}"></script>
@endsection
