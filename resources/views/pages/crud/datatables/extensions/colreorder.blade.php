...
@section('content')
    ...
    <div class="container">
        ...
        <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
            ...
            <div class="alert-text">ColReorder adds the ability for the end user to be able to reorder columns in a
                DataTable through a click and drag operation. See official documentation
                <a class="font-weight-bold" href="https://datatables.net/extensions/colreorder/" target="_blank">here</a>.
            </div>
        </div>
        <!--end::Notice-->
        <!--begin::Card-->
            ...
            <div class="card-header">
                <div class="card-title">
                    <span class="card-icon">
                        <i class="flaticon2-infographic text-primary"></i>
                    </span>
                    <h3 class="card-label">ColReorder DataTable</h3>
                </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/pages/crud/datatables/extensions/colreorder.js') }}"></script>
@endsection
