...
@section('content')
    ...
    <div class="container">
        ...
        <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
            ...
            <div class="alert-text">reCAPTCHA v3 returns a score for each request without user friction. The score is based
                ...
                <a class="font-weight-bold" href="https://developers.google.com/recaptcha/docs/v3" target="_blank">Demo
                    Page</a>.
            </div>
        </div>
        <!--end::Notice-->
        ...
        <div class="card card-custom example example-compact">
            <div class="card-header">
                <h3 class="card-title">Google reCaptcha Examples</h3>
