            ...
            <div class="col-lg-6">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">Default Balloon Demo</h3>
                    ...
                    <div class="card-body">
                        <div id="kt-ckeditor-1">
                            <p>Highlight text to trigger the editor</p>
                            <h1>Quick and simple CKEditor 5 Integration</h1>
                            <p>Here goes the initial content of the editor. Lorem Ipsum is simply dummy text of the printing
                            ...
                            <p>Lorem ipsum dolor sit amet,consectetuer edipiscing elit,sed diam nonummy nibh euismod
                                ...
                                elit,sed diam nonummy nibh euismod tinciduntut laoreet doloremagna aliquam erat volutpat.Ut
                                wisi enim ad minim veniam,quis nostrud exerci tation ullamcorper.</p>
...
<code class="language-js">
            ...
            <div class="col-lg-6">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">Balloon Demo with Multiple Font Styles</h3>
                        <div class="card-toolbar">
                            <div class="example-tools justify-content-center">
                                <span class="example-toggle" data-toggle="tooltip" title="View code"></span>
                            </div>
                    ...
                    <div class="card-body">
                        <div id="kt-ckeditor-2">
                            ...
                            <h1>Quick and simple CKEditor 5 Integration</h1>
                            <p>Here goes the
                                <a href="#">Minitial content of the editor</a>. Lorem Ipsum is simply dummy text of
                                the
...
<code class="language-html">
                            &lt;div class="card card-custom"&gt;
                                &lt;div class=" card-header"&gt;
                                    &lt;h3 class="card-title"&gt;
                                        Balloon Demo with Multiple Font Styles
                                    &lt;/h3&gt;
                                &lt;/div&gt;
                                &lt;div class="card-body"&gt;
                                    &lt;div id="kt-ckeditor-2"&gt;
...
<code class="language-js">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">Balloon Demo with Images</h3>
                        <div class="card-toolbar">
                            <div class="example-tools justify-content-center">
                                <span class="example-toggle" data-toggle="tooltip" title="View code"></span>
                            </div>
...
<code class="language-js">
            ...
            <div class="col-lg-6">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">Balloon Demo with Videos</h3>
                        <div class="card-toolbar">
                            <div class="example-tools justify-content-center">
                                <span class="example-toggle" data-toggle="tooltip" title="View code"></span>
                            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-custom example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">Large Balloon Demo</h3>
                        <div class="card-toolbar">
                            <div class="example-tools justify-content-center">
                                <span class="example-toggle" data-toggle="tooltip" title="View code"></span>
                            </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/pages/crud/forms/editors/ckeditor-balloon.js') }}"></script>
    <!--end::Page Scripts-->
@endsection
