...
@section('content')
    ...
    <div class="container">
        ...
        <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
            ...
            <div class="alert-text">The Metronic Datatable component can be displayed in modal pop-ups with vertical
                scrolling. For more information visit
                ...
                <div class="modal-content" style="min-height: 590px;">
                    <div class="modal-header py-5">
                        <h5 class="modal-title">Sub Datatable in Modal Pop-up
                            <span class="d-block text-muted font-size-sm">sub datatable for the selected row is loaded from
                                remote data source</span>
                        </h5>
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-light-danger font-weight-bold" data-toggle="modal"
                            data-target="#kt_datatable_modal_2">Launch Modal</a>
                    </div>
                </div>
                <!--end::Card-->
            </div>
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-light-success font-weight-bold" data-toggle="modal"
                            data-target="#kt_datatable_modal_3">Launch Modal</a>
                    </div>
                </div>
                <!--end::Card-->
            </div>
                                ...
                                <div class="col-lg-9 col-xl-8">
                                    <div class="row align-items-center">
                                        <div class="col-md-4 my-2 my-md-0">
                                            <div class="input-icon">
                                                <input type="text" class="form-control" placeholder="Search..."
                                                    id="kt_datatable_search_query_3" />
                                                <span>
                                                    <i class="flaticon2-search-1 text-muted"></i>
                                                </span>
                                            </div>
                                ...
                                <div class="col-lg-9 col-xl-8">
                                    <div class="row align-items-center">
                                        <div class="col-md-4 my-2 my-md-0">
                                            <div class="input-icon">
                                                <input type="text" class="form-control" placeholder="Search..."
                                                    id="kt_datatable_search_query_4" />
                                                <span>
                                                    <i class="flaticon2-search-1 text-muted"></i>
                                                </span>
                                            </div>
