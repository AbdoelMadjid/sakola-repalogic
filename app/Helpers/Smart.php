...
if (!function_exists('getRoleName')) {
    function getRoleName()
    {
        ...
        if ($user && $user->roles->isNotEmpty()) {
            ...
            return roleDisplayName($roleName);
        }
...
if (!function_exists('renderDate')) {
    function renderDate($locale = null)
    {
        $date = Carbon::now('Asia/Jakarta');
        ...
        $dayNameMap = [
            ...
            'en' => [
                0 => "<font color='red'>Sunday</font>",
                1 => "Monday",
                2 => "Tuesday",
                3 => "Wednesday",
                4 => "Thursday",
                5 => "<font color='#1f9d81'><b>Friday</b></font>",
                6 => "Saturday"
            ],
        ];
        ...
        $day = $dayNameMap[$activeLocale][$date->dayOfWeek];
        $daym = $date->day;
        $month = $monthNameMap[$activeLocale][$date->month - 1];
        $year = $date->year;
